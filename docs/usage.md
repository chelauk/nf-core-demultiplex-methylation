...
```bash
nextflow run nf-core-demultiplex --reads '*_R{1,2}.fastq.gz' -profile icr_davros,singularity -c local.config
```
...
The default is currently set at '/scratch/DMP/EVGENMOD/gcresswell/MolecularClocks/genomes/'
